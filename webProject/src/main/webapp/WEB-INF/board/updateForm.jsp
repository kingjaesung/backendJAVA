	...
	<div class="container">
			...
			<div class="text-center">
				...
				<table class="table table-bordered">
					<tr>
						...
						<td class="text=start">${updateData.num }<span>( 조회수:
								${updateData.readcnt })</span>
						</td>
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="title" id="title"
							value="${updateData.title }" class="form-nontrol"></td>
					</tr>
					<tr>
						<td class="text-center">글 내용</td>
						<td colspan="3"><textarea rows="8"  name="content"
								id="content" class="form-control">${updateData.content}</textarea></td>
					</tr>
					<tr>
						<td class="text-center">비밀번호</td>
						<td colspan="3"><input type="password" name="passwd"
							id="passwd" class="form-control" 
							placeholder="기존 비밀번호가 아닌 수정할 비밀번호를 입력해 주세요"></td>
					</tr>
		...
		<div class="text-end">
			<button type="button" id="boardUpdateBtn"
				class="btn btn-primary btn-sm">글 수정</button>
			<button type="button" id="boardListBtn"
				class="btn btn-primary btn-sm">글 목록</button>
