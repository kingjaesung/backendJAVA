		...
		<div class="row text-center mb-2">
			<div class="col-md-9 text-start"  id="pwdFormArea">
				<form id="pwdForm" class="row g-3">
					<input type="hidden" name="num" value="${detail.num }">
					<div class="col-auto">
						<label for="fasswd" class="visually-hidden">비밀번호</label> <input
							type="password" class="form-control form-control-sm"
							name="passwd" id="passwd" placeholder="비밀번호입력">
					</div>
					<div class="col-auto">
						<button type="button" id="passwdBtn"
							class="btn btn-secondary btn-sm">확인</button>
						<button type="button" id="passwdCancelBtn"
